...
export const envSchema = z
  ...
  .refine(
    (env) => env.JWT_FORCE_PASSWORD_CHANGE_SECRET !== env.JWT_ACCESS_SECRET,
    {
      path: ['JWT_FORCE_PASSWORD_CHANGE_SECRET'],
      message:
        'JWT_FORCE_PASSWORD_CHANGE_SECRET must differ from JWT_ACCESS_SECRET',
    },
  );
